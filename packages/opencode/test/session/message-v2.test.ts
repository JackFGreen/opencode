...
describe("session.message-v2.toModelMessage", () => {
  ...
  test("handles tool output with empty text but has attachments", async () => {
    const userID = "m-user"
    const assistantID = "m-assistant"
  ...
  test("handles tool output with empty text and no attachments returns placeholder", async () => {
    const userID = "m-user"
    const assistantID = "m-assistant"
